...
public class BichosFragment extends Fragment implements  View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonCao = view.findViewById(R.id.buttonDog);
        buttonGato = view.findViewById(R.id.buttonCat);
        buttonLeao = view.findViewById(R.id.buttonLion);
        buttonMacaco = view.findViewById(R.id.buttonMonkey);
        buttonOvelha = view.findViewById(R.id.buttonSheep);
        buttonVaca = view.findViewById(R.id.buttonCow);
