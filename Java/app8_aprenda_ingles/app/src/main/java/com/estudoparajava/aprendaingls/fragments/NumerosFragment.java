...
public class NumerosFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonUm = view.findViewById(R.id.buttonOne);
        buttonDois = view.findViewById(R.id.buttonTwo);
        buttonTres = view.findViewById(R.id.buttonThree);
        buttonQuatro = view.findViewById(R.id.buttonFour);
        buttonCinco = view.findViewById(R.id.buttonFive);
        buttonSeis = view.findViewById(R.id.buttonSix);
